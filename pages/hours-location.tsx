...
const HoursLocation = () => (
    <>
        <Head>
            <title>Sample: Hours and Location</title>
            <meta name='description' content='Sample business is open Monday to Saturday. Sample is located at 123 Example Street.'></meta>
        </Head>
